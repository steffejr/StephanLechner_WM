...
function MakeAdaptiveStimulus(Load, LastTrialStimulus, LastTrialProbe, AllowableLetters)
	// Make stimuli on-the-fly and make sure that no current letters were included in the previous trial
	{
		console.log("Making Adaptive Stimuli: ")
		console.log("Allowable letters: ")
		...
		console.log("Make Adaptive Stimuli:")
		console.log("Letters to Use: ")
		console.log(LettersToUse)
