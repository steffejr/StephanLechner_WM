function DMS_Scoring(Stair, data) {
	...
	Results.AllResults['Load List'] = Stair.ValueList
	Results.AllResults['Response Time List'] = Stair.ResponseTimeList
	Results.AllResults['Accuracy List'] = Stair.AccuracyList
	Results.AllResults['NDown'] = Stair.NDown
	Results.AllResults['NUp'] = Stair.NUp
	// NUMERIC SCORING
	...
	//Results.parameters = SPATIAL_DMS_PARAMS
	return Results
}
