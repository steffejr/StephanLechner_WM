...
EN_Instructions.Instructions01 = [
	...
	{'page': '<div class="InstructImage"><img src=EN_VSTMInstructions.png max-width="600px" alt=Instructional image</img></div>'},
...
FR_Instructions.Instructions01 = [
	{'page': 'Il s\'agit d\'un test de mémoire à court terme. Vous verrez un ou plusieurs points à l\'écran et vous devrez vous rappeler où ils se trouvent. Ils seront supprimés de l\'écran après quelques secondes. Vous verrez un seul point bleu. Vous devez décider si le point bleu se trouve ou non dans l’un des endroits que vous avez étudiés.'},{'page': '<div class="InstructImage"><img src=FR_VSTMInstructions.png max-width="600px" alt=Instructional image</img></div>'},
