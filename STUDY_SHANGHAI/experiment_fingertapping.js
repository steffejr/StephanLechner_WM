jatos.onLoad(function() {
    console.log("=== FINGER TAPPING COMPONENT 2 STARTING ===");
    
    // Debug: Check what data we received from Component 1
    console.log("All session data in Component 2:", jatos.studySessionData);
    
    // GET SUBJECT ID FROM COMPONENT 1
    const subjectId = jatos.studySessionData.subjectId;
    console.log("Subject ID from Component 1:", subjectId);
    ...
    // Get subject info - using the ID from Component 1
    ...
    function saveData() {
        ...
        // const filename = `${dateStr}_${timeStr}_${subjectId}.csv`;
